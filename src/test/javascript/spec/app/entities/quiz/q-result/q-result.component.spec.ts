...
import { QResultComponent } from 'app/entities/quiz/q-result/q-result.component';
...
describe('Component Tests', () => {
  describe('QResult Management Component', () => {
    let comp: QResultComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(QResultComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.qResults && comp.qResults[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
