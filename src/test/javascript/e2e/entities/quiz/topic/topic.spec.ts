...
describe('Topic e2e test', () => {
  ...
  it('should load Topics', async () => {
    ...
    expect(await topicComponentsPage.getTitle()).to.eq('eo2GatewayApp.quizTopic.home.title');
  ...
  it('should load create Topic page', async () => {
    ...
    expect(await topicUpdatePage.getPageTitle()).to.eq('eo2GatewayApp.quizTopic.home.createOrEditLabel');
  ...
  it('should create and save Topics', async () => {
    ...
    await promise.all([topicUpdatePage.setNameInput('name')]);
  ...
  it('should delete last Topic', async () => {
    ...
    expect(await topicDeleteDialog.getDialogTitle()).to.eq('eo2GatewayApp.quizTopic.delete.question');
