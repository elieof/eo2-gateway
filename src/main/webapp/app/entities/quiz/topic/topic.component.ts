...
export class TopicComponent implements OnInit, OnDestroy {
    ...
    loadPage(page?: number): void {
        ...
        if (this.currentSearch) {
            this.topicService
                ...
                .subscribe(
                    (res: HttpResponse<ITopic[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
                    () => this.onError()
                );
            return;
        }
    ...
    registerChangeInTopics(): void {
        this.eventSubscriber = this.eventManager.subscribe('topicListModification', () => this.loadPage());
    }
    ...
    protected onSuccess(data: ITopic[] | null, headers: HttpHeaders, page: number): void {
