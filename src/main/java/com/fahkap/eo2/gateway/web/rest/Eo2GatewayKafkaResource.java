...
@RestController
@RequestMapping("/api/eo-2-gateway-kafka")
public class Eo2GatewayKafkaResource {

    private final Logger log = LoggerFactory.getLogger(Eo2GatewayKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public Eo2GatewayKafkaResource(KafkaProperties kafkaProperties) {
